...
// Self-hosted fonts (Fraunces, JetBrains Mono, Cairo) — replaces next/font/google
// after Vite migration. Bundled via @fontsource npm packages.
import "@pos/styles/fonts.css";
import { useSession, signIn, AUTH_PROVIDER, CLERK_KEY_CONFIGURED } from "@shared/lib/auth-bridge";
import { ThemeProvider } from "next-themes";
import { SWRConfig } from "swr";
import { swrConfig } from "@shared/lib/swr-config";
              ...
              <SessionGuard>
                ...
                <BrandProvider>
                  <RendererCrashBridge>
                    <PosKeyboardHandler>
                      <div
                        className="pos-omni flex min-h-screen flex-col overflow-hidden bg-[var(--pos-bg)] text-[var(--pos-ink)]"
                      >
                        {children}
                      </div>
                    </PosKeyboardHandler>
