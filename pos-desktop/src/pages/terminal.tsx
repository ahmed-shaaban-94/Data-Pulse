...
import { TopStatusStrip } from "@pos/components/terminal/TopStatusStrip";
import { useActiveShift } from "@shared/hooks/use-active-shift";
import { PharmacistVerification } from "@pos/components/PharmacistVerification";
...
import { TotalsHero } from "@pos/components/terminal/TotalsHero";
import { ShortcutLegend } from "@pos/components/terminal/ShortcutLegend";
import { ShortcutsCheatSheet } from "@pos/components/ShortcutsCheatSheet";
...
import { type InsuranceState } from "@pos/components/terminal/ActivePaymentStrip";
import { ScanToast } from "@pos/components/terminal/ScanToast";
import { ScanDisambigPicker } from "@pos/components/terminal/ScanDisambigPicker";
import { ProvisionalBanner } from "@pos/components/terminal/ProvisionalBanner";
import { productToQuickPick, type TilePaymentMethod } from "@pos/components/terminal/types";
...
import { CustomerBar } from "@pos/components/terminal/CustomerBar";
import { ChurnAlertCard } from "@pos/components/terminal/ChurnAlertCard";
import { ShiftOpenModal } from "@pos/components/terminal/ShiftOpenModal";
import { ManagerPinOverrideModal } from "@pos/components/terminal/ManagerPinOverrideModal";
import { usePosCustomerLookup } from "@pos/hooks/use-pos-customer-lookup";
import { useManagerOverride } from "@shared/hooks/use-manager-override";
...
export default function PosTerminalPage() {
  ...
  useEffect(() => {
    const redirect = () => navigate("/sync-issues");
