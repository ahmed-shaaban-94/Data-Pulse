...
def get_staff_quota(
    ...
    from datapulse.analytics.models import StaffQuota
...
def get_product_affinity(
    ...
    from datapulse.analytics.models import AffinityPair
...
def get_churn_predictions(
    ...
    from datapulse.analytics.models import ChurnPrediction
