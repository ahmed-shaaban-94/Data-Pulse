...
import { ChevronDown, Search, X, Building2, UserCog, Tag, Layers } from "lucide-react";

/* ------------------------------------------------------------------ */
/*  Generic dropdown slicer (Power BI style)                          */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  Slicer Panel (Power BI style filter bar)                          */
/* ------------------------------------------------------------------ */
