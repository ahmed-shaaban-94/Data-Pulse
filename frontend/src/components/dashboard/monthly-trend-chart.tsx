...
export function MonthlyTrendChart() {
  ...
  return (
    <div className="group rounded-xl border border-border bg-card p-5 transition-all duration-300 hover:border-chart-blue/30 hover:shadow-lg hover:shadow-chart-blue/5">
