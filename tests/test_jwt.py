...
class TestFetchJWKS:
    @patch("datapulse.api.jwt.httpx.get")
...
class TestVerifyJWT:
    @patch("datapulse.api.jwt.jwt.decode", side_effect=pyjwt.ExpiredSignatureError)
    @patch("datapulse.api.jwt._get_signing_key")
    ...
    @patch("datapulse.api.jwt._get_signing_key")
    @patch("datapulse.api.jwt.jwt.decode")
